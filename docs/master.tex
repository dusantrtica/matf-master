...
studenata po smeru i semestru, kao
...
grupa, a time i na ukupan broj sesija, i na ukupan broj nedostajućih
mesta po sesijama, koji meri meko ograničenje kapaciteta (odeljak
\ref{sec:kapacitet}). Struktura problema time se ne menja, a poređenje
dve formulacije ostaje korektno, jer oba rešavača dobijaju isti ulaz.
Zaključci o tome kako se model ponaša pri rastu instance takođe ne
zavise od tačnosti procena, ali broj nedostajućih mesta treba čitati
kao red veličine, a ne kao tačan podatak.
...
\item \textbf{Formiranje grupa studenata.}
  ...
  veličina grupa iznosi 918 umesto 919. Na preliminarnu evaluaciju
  (odeljak \ref{sec:preliminarna-evaluacija}) to ne
...
minimizuje zajedno sa ostalim komponentama cilja. Blok će, dakle, ostati
nespojen kada je ta kazna manja od zbira kazni koje bi spajanje izazvalo
kod drugih pravila; nije reč o tome da rešavač pravilo krši samo kada je
dopustivost drugačije nemoguća.
...
kada u rasporedu nema nedostajućih mesta. Pošto je ovo meko pravilo,
rešavač sme da izabere premalu učionicu kad god je zbir ušteda kod
drugih komponenti cilja veći od cene prekoračenja; prekoračenje, dakle,
ne znači nužno da odgovarajuća učionica nije bila slobodna.
...
rešavača. Cena po prekršaju je pri tome namerno niska (1 po
nedostajućem mestu), ali pošto se sabira po mestima, dovoljno veliko
prekoračenje ipak može da prevagne nad ostalim komponentama: deset
nedostajućih mesta nosi kaznu 10, dakle više od tri procepa u rasporedu
grupe (6) ili od tri dodatna radna dana nastavnika (9).
