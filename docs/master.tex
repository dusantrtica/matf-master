...
\pgfplotsset{trajplot/.style={
  width=\linewidth, height=7cm, grid=major,
  xlabel={vreme pretrage (s)}, ylabel={vrednost funkcije cilja},
  const plot, mark size=1pt,
  scaled ticks=false,
...
U ovoj glavi izlažemo teorijski okvir problema, a potom prelazimo na
specifikaciju. Najpre definišemo problem raspoređivanja
...
Ograničenja delimo u dve kategorije:
...
za ograničenja tipa: da sesija može biti raspoređena samo u podskup učionica.
...
\end{equation}
dakle $O(|\mathcal{S}| + DHR + GDH)$. Kraći zapis $O(DHR + GDH)$
opravdan je kada važi $|\mathcal{S}| \leq DHR$, što na instancama iz
ovog rada jeste slučaj (722 naspram 1740 na najvećoj skali).
...
zavisnostima. Izvorni kod, ulazni podaci i izvor ovog rada javno su
dostupni na adresi \url{https://github.com/dusantrtica/matf-master}.
...
proizvoljno određena. Ravnomerna podela na grupe je pojednostavljenje:
stvarne grupe nisu iste veličine.
...
Predavanja i vežbe istog predmeta su nezavisne jedinice raspoređivanja:
kvota (\texttt{theory} i \texttt{practice}), nastavnik, sastav slušalaca
i zahtev za računarima zadaju se odvojeno po tipu nastave, pa se termin
i učionica za njih biraju nezavisno.
...
\item \texttt{penalty > 0} -- \textbf{meko} (eng. \emph{soft})
  ...
  uz datu cenu. Ovo predstavlja težinski faktor prekršaja.
\end{itemize}
...
rešavača. Cena je 1 po nedostajućem mestu, ali se sabira po mestima, pa
dovoljno veliko prekoračenje može prevagnuti nad ostalim komponentama
cilja.
...
Obe evaluacije koriste isti ulazni fajl i parne semestre
studija, pa se odnose na istu nastavu; razlikuju se po tome koliko je
pravila u modelu i kako se grupe studenata formiraju.
...
Ovde se grupe studenata dobijaju deljenjem broja upisanih na grupe od najviše 50
...
Napomena vezana za merenje memorije. \texttt{tracemalloc} prati
...
podrazumevanim podešavanjima, i na tri opisane instance. O paradigmama
uopšte ne tvrdimo ništa: drugačija formulacija, drugačije podešen
rešavač ili instanca druge strukture mogli bi dati drugačiji odnos.
...
MIP model radi bez funkcije cilja. Time ostaje neiskorišćen
...
Za razliku od prve evaluacije, ovde nas ne zanima samo
...
predmeta koji sluša (2, 4, 6 ili 8), što odgovara godini studija:
...
sa osobljem, a za najveću skalu je ista putanja prikazana i krivom na
slici \ref{fig:traj_l}. Konfiguracija bez osoblja prolazi kroz istu vrstu putanje
...
dopustivo rešenje, ali ni ne dokaže da rešenje ne postoji.
...
Tabela \ref{tbl:tight_checkpoints} daje vrednost funkcije cilja u zadatim
trenucima.
...
to pokretanje data je u tabeli \ref{tbl:tight_traj_l}, a na slici
\ref{fig:traj_l} je prikazana zajedno sa putanjom iste instance u
realnom okruženju. Poređenje pokazuje u čemu je razlika:
u zaoštrenom okruženju prvo dopustivo rešenje dolazi kasnije, pad cilja
traje oko tri puta duže, a kriva se na kraju zaustavlja na 6 umesto da
padne na nulu.

\newcommand{\trajRealno}{
  (27.46,3095) (27.66,3053) (27.96,2999) (28.19,2947) (28.63,2824)
  (29.26,2592) (29.53,2444) (29.9,1848) (31.36,1838) (31.55,1557)
  (31.96,1386) (32.21,1380) (34.17,1072) (36.68,1026) (37.21,936)
  (38.35,880) (38.77,833) (42.26,761) (42.4,612) (42.67,606) (42.99,600)
  (43.55,555) (45.83,545) (47.16,375) (49.95,367) (50.56,300) (51.77,292)
  (53.67,270) (55.12,254) (55.81,215) (57.23,214) (57.8,136) (58.35,114)
  (61.42,113) (61.66,111) (61.89,110) (62.13,108) (62.42,105) (62.54,86)
  (63.41,84) (63.68,82) (63.97,80) (64.24,79) (64.49,77) (64.67,51)
  (64.95,49) (65.3,47) (66.01,45) (66.58,44) (67.2,42) (68.57,39)
  (68.93,38) (69.15,35) (69.86,33) (70.11,32) (70.39,29) (70.7,27)
  (70.94,26) (71.33,24) (71.94,23) (72.44,21) (72.87,20) (73.49,17)
  (74.09,16) (74.35,14) (74.61,13) (74.83,11) (75.13,9) (75.34,6)
  (75.74,5) (76.07,3) (76.35,2) (76.66,0)}

\newcommand{\trajZaostreno}{
  (50.61,2821) (50.76,2795) (50.95,2791) (54.15,2716) (54.46,2293)
  (54.82,2258) (55.09,1978) (56.08,1663) (57.05,1431) (61.15,867)
  (62.09,861) (63.49,724) (63.7,536) (64.07,509) (66.34,445) (67.76,411)
  (70.09,384) (70.63,322) (70.84,320) (71.53,293) (72.27,287) (75.34,263)
  (75.67,254) (76.66,202) (77.06,188) (80.96,165) (83.59,162) (86.39,136)
  (87.6,128) (87.78,125) (87.93,116) (88.46,113) (88.91,103) (92.01,82)
  (92.92,80) (95.61,73) (95.99,68) (96.78,63) (100.71,62) (101.46,60)
  (109.18,56) (111.45,53) (112.73,48) (118.43,41) (123.01,39) (133.02,36)
  (137.02,33) (140.49,30) (145.16,29) (145.83,27) (146.88,24) (149.28,21)
  (160.57,18) (168.03,15) (170.78,14) (189.3,11) (194.32,6)}

\begin{figure}[ht]
\centering
\begin{tikzpicture}
\begin{axis}[trajplot, height=6cm, legend pos=north east,
             xmin=20, xmax=200]
\addplot[color=blue!70!black] coordinates {\trajRealno};
\addlegendentry{realno okruženje}
\addplot[color=red!75!black] coordinates {\trajZaostreno};
\addlegendentry{zaoštreno okruženje}
\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
\begin{axis}[trajplot, height=5cm, xmin=20, xmax=200, ymin=-4, ymax=120,
             ylabel={cilj (uvećan opseg)}]
\addplot[color=blue!70!black] coordinates {\trajRealno};
\addplot[color=red!75!black] coordinates {\trajZaostreno};
\end{axis}
\end{tikzpicture}
\caption{Vrednost funkcije cilja u zavisnosti od vremena pretrage,
FINAL-L sa osobljem. Svaka tačka je jedno prijavljeno poboljšanje. Donji
panel je uvećan na poslednjih stotinak poena cilja, gde se vidi da se
kriva u zaoštrenom okruženju zaustavlja na 6, dok u realnom pada na
nulu.}
\label{fig:traj_l}
\end{figure}
...
\item \textbf{Raspoloživost nastavnika nije modelovana.} Model ne
  poznaje termine u kojima nastavnik ne može da drži nastavu.
