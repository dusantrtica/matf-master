...
zavisnostima. U fajlu \texttt{MODULE.bazel} navodi se modul
\texttt{rules\_python}, koji obezbeđuje podršku za Python. Zavisnosti se
ne instaliraju iz okruženja u kome se gradnja pokreće: ekstenzija
\texttt{pip.parse} čita zaključane verzije paketa iz fajla
\texttt{requirements.txt} i pravi ih dostupnim pod imenom
\texttt{@pip}, dok \texttt{python.toolchain} fiksira verziju
interpretera na Python 3.11. Time se postiže hermetičnost: gradnja
koristi istu verziju Pythona i iste verzije paketa na svakoj mašini.
...
\medskip
\noindent\textbf{Terminološka napomena.}
Entitet kojim se studenti grupišu prema nastavnom planu koji pohađaju
u ovom radu nazivamo \emph{smer}. Reč je o jedinici nastavnog plana, a
ne o organizacionoj jedinici fakulteta: smer okuplja studente prema
predmetima koje slušaju, dok katedra okuplja nastavnike prema naučnoj
oblasti, pa se ta dva pojma ne poklapaju.
...
\item \textbf{broj časova} -- \texttt{quota.theory} i
  ...
  npr. 2 predavanja i 3 vežbe nedeljno, ili vežbe uopšte ne imati,
...
amfiteatru, dok vežbe iz istog predmeta zahtevaju računarsku učionicu.
...
Ovo razdvajanje nije samo pitanje tačnosti modela nego i praktične
dopustivosti rasporeda. Računarske učionice su najoskudniji resurs: u
realnim podacima Matematičkog fakulteta samo 8 od 29 učionica ima
računare. Kada bi predavanja nasleđivala zahtev predmeta, sva
predavanja iz 37 računarskih predmeta bespotrebno bi se takmičila za
te 8 učionica, iako mogu u bilo koju veću salu. Efekat na veličinu
modela i vreme rešavanja razmatramo u glavi \ref{chp:evaluacija}.
