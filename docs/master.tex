...
Na osnovu ovih rezultata, CP-SAT je jasni izbor za dalju nadogradnju
sistema za raspoređivanje časova.

\section{Dalji rad}

U drugom delu ovog rada planiramo sledeća proširenja:

\begin{enumerate}
\item \textbf{Meka ograničenja i optimizacija.}
  Dodavanje funkcije cilja koja optimizuje kvalitet rasporeda --
  na primer, minimizacija rupa u rasporedu za studente,
  ravnomerna raspodela časova i izbegavanje kasnih termina.

\item \textbf{Rasporedivanje nastavnog osoblja.}
  Uključivanje profesora i asistenata u model, sa ograničenjima
  njihove raspoloživosti i preferencija.

\item \textbf{Lokacijska ograničenja.}
  Ograničenja koja sprečavaju da profesor ili grupa studenata
  mora da menja lokaciju (zgradu) u toku jednog dana ili u
...
\item \textbf{Veb interfejs.}
  ...
  FastAPI okruzenja za serversku stranu.
\end{enumerate}
