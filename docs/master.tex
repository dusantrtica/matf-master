...
Prednosti korišćenja Pydantic-a vidljive su i na ovom kratkom primeru:
\begin{itemize}
...
Isti mehanizam kasnije prima još jedan uslov: kada su grupe studenata
eksplicitno zadate u ulazu, pa su veličine sesija pouzdane, u listu
\texttt{allowed} ulaze samo učionice dovoljnog kapaciteta (odeljak
\ref{sec:cohorts}).
...
Izmereni broj MIP promenljivih ($1\,179\,720$ za MATF-L) niži je od
gornje granice $762 \cdot 1740 = 1\,325\,880$ zato što MIP formulacija
uopšte ne kreira promenljive za nedozvoljene učionice (sekcija
\ref{sec:mip_form}). Ovde se vidi i posledica toga što zahtev za
računarima zavisi od tipa nastave (sekcija
\ref{sec:nezavisnost_tipova}): kada bi predavanja nasleđivala zahtev
predmeta, njihov izbor bio bi sužen na 8 računarskih učionica, pa bi
MIP model bio \emph{manji}, ali bi opisivao strože i nerealno
ograničen problem. Isti efekat, u obrnutom smeru, vidi se na CP strani
-- broj ograničenja je manji jer se \texttt{AllowedAssignments} dodaje
samo sesijama koje su zaista vezane za računarske učionice.
...
(\code{input_full_2_semester.json}), u kojima su grupe eksplicitno
zadate, pa se poštuje i kapacitet učionica. Svaka grupa nosi semestar
(2, 4, 6 ili 8), što odgovara godini studija, te se instanca može seći
po godinama:
...
lokacije. Razlog je što se uz eksplicitno zadate grupe poštuje i
kapacitet učionica, pa bi istovremeno smanjivanje broja učionica lako
dalo nedopustive instance i time zamaglilo efekat rasta problema.
Filtriranje se radi samo nad predmetima, grupama i upisima; dodele
nastavnika koje se odnose na izbačene predmete jednostavno se ne
aktiviraju, pa ulaz sa osobljem ostaje nepromenjen.
...
\item \textbf{bez osoblja} -- pravila iz glave \ref{chp:nadogradnja}:
  spajanje časova u blokove kao tvrdo ograničenje i izbegavanje procepa
  kao meko ograničenje sa cenom 2;
...
\]
pri čemu u konfiguraciji bez osoblja drugi sabirak ne postoji. Vrednost
0 znači da nijedno meko ograničenje nije prekršeno, dakle raspored bez
ijednog procepa i bez ijednog nastavnika koji radi više dana nego što mu
je dozvoljeno.
...
Pošto CP-SAT paralelno izvršava portfolio strategija, pretraga nije
deterministička i putanja poboljšanja se između pokretanja razlikuje u
detaljima; prikazani su rezultati jednog reprezentativnog pokretanja.
...
\midrule
Sesije             & $204$      & $199$      & $398$      & $378$       & $722$      & $685$ \\
Promenljive        & $15\,144$  & $36\,278$  & $29\,628$  & $70\,209$   & $53\,952$  & $116\,624$ \\
Ograničenja        & $27\,829$  & $63\,533$  & $54\,366$  & $122\,961$  & $98\,857$  & $206\,049$ \\
Vreme konstrukcije & 0,09 s     & 0,20 s     & 0,17 s     & 0,39 s      & 0,31 s     & 0,66 s \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Metrika} & bez & sa & bez & sa & bez & sa \\
\midrule
Prvo rešenje         & 1,42 s & 2,58 s  & 4,13 s & 7,24 s   & 20,74 s & 18,81 s \\
Cilj prvog rešenja   & $0$    & $48$    & $0$    & $182$    & $0$     & $282$ \\
Broj nađenih rešenja & $1$    & $4$     & $1$    & $16$     & $1$     & $23$ \\
Vreme do najboljeg   & 1,42 s & 3,03 s  & 4,13 s & 10,51 s  & 20,74 s & 30,86 s \\
Ukupno vreme         & 1,44 s & 3,05 s  & 4,15 s & 10,58 s  & 20,79 s & 30,96 s \\
...
sa osobljem. Konfiguracija bez osoblja se ne prikazuje na ovaj način jer
u njoj rešavač već prvim rešenjem pogađa optimum, pa se putanja svodi na
jednu tačku.
...
\midrule
7,24 s & $182$ & 9,00 s  & $82$ \\
7,78 s & $130$ & 9,08 s  & $30$ \\
7,95 s & $100$ & 9,26 s  & $28$ \\
8,01 s & $98$  & 9,27 s  & $21$ \\
8,53 s & $90$  & 9,45 s  & $18$ \\
8,63 s & $88$  & 9,47 s  & $16$ \\
8,64 s & $86$  & 10,22 s & $6$  \\
...
\textbf{Vreme} & \textbf{Cilj} & \textbf{Vreme} & \textbf{Cilj} \\
\midrule
18,81 s & $282$ & 24,23 s & $45$ \\
19,26 s & $236$ & 24,82 s & $43$ \\
20,28 s & $234$ & 25,56 s & $39$ \\
20,46 s & $182$ & 25,92 s & $23$ \\
21,08 s & $180$ & 25,93 s & $21$ \\
21,12 s & $106$ & 26,37 s & $11$ \\
21,82 s & $102$ & 27,36 s & $9$  \\
21,85 s & $99$  & 28,02 s & $6$  \\
23,07 s & $88$  & 28,19 s & $5$  \\
23,51 s & $71$  & 29,46 s & $3$  \\
24,00 s & $57$  & 30,71 s & $2$  \\
       &       & 30,86 s & $0$  \\
\bottomrule
\end{tabular}
\end{table}
...
dostigne cilj 0, i to za nekoliko desetina sekundi. Razlog je što realna
instanca ima mnogo slobodnog prostora: 29 učionica puta 60 termina
nedeljno daje 1740 mesta za najviše 685 časova, dakle popunjenost ispod
40\%. U tako labavom rasporedu meka ograničenja gotovo da ne dolaze u
sukob, pa kriva funkcije cilja brzo padne na nulu i o dinamici pretrage
govori malo.
...
\begin{itemize}
\item nastava traje od 8 do 14 časova umesto do 20, čime broj termina
  pada sa 1740 na 870, pa je najveća instanca popunjena 79\%;
\item podrazumevani najveći broj radnih dana nastavnika smanjen je sa 4
  na 2 (lični limiti pojedinih nastavnika, koji su ionako stroži,
  ostaju nepromenjeni).
\end{itemize}

Ova granica nije birana proizvoljno. Zona u kojoj je problem istovremeno
rešiv i netrivijalan pokazala se vrlo uskom: pri 870 termina rešavač
nalazi i dokazuje optimum, dok već pri 720 termina (nastava do 13 časova,
ili izostavljanje zgrade u Nemanjinoj ulici) ne pronalazi nijedno
dopustivo rešenje ni za punih 600 sekundi. Zaoštreno okruženje je,
dakle, postavljeno tik uz granicu rešivosti.
...
\begin{table}[ht]
\centering
\caption{Tok rešavanja u zaoštrenom okruženju (8--14 časova)}
\label{tbl:tight_tok}
\begin{tabular}{lrrrrrr}
\toprule
& \multicolumn{2}{c}{\textbf{FINAL-S}}
...
\textbf{Metrika} & bez & sa & bez & sa & bez & sa \\
\midrule
Promenljive          & $8\,064$  & $18\,728$ & $15\,768$ & $36\,219$ & $28\,692$ & $60\,374$ \\
Ograničenja          & $14\,389$ & $32\,663$ & $28\,086$ & $63\,171$ & $51\,037$ & $106\,059$ \\
Prvo rešenje         & 0,58 s    & 1,25 s    & 2,11 s    & 6,38 s    & 273,07 s  & 37,44 s \\
Cilj prvog rešenja   & $0$       & $14$      & $8$       & $45$      & $102$     & $200$ \\
Broj nađenih rešenja & $1$       & $5$       & $2$       & $19$      & $19$      & $41$ \\
Vreme do najboljeg   & 0,58 s    & 1,42 s    & 2,17 s    & 7,78 s    & 295,11 s  & 173,93 s \\
...
cilj pada sa 200 na 135, pa na 57, 51, 27, 19 i konačno 6, i to kroz
skoro tri minuta pretrage. Cela putanja poboljšanja za to pokretanje data
je u tabeli \ref{tbl:tight_traj_l}.
...
& \textbf{Vreme} & \textbf{Cilj} \\
\midrule
37,44 s & $200$ & 45,85 s & $77$ & 83,08 s  & $35$ \\
37,54 s & $196$ & 45,86 s & $75$ & 83,15 s  & $33$ \\
37,84 s & $194$ & 47,63 s & $72$ & 87,13 s  & $30$ \\
38,04 s & $191$ & 47,99 s & $71$ & 88,40 s  & $27$ \\
38,25 s & $189$ & 49,78 s & $57$ & 90,05 s  & $24$ \\
38,39 s & $173$ & 51,88 s & $56$ & 100,78 s & $23$ \\
38,40 s & $168$ & 56,31 s & $54$ & 107,54 s & $22$ \\
38,52 s & $164$ & 58,52 s & $51$ & 110,48 s & $19$ \\
39,19 s & $162$ & 60,61 s & $47$ & 124,38 s & $15$ \\
39,65 s & $156$ & 64,48 s & $45$ & 127,76 s & $14$ \\
39,86 s & $135$ & 65,66 s & $44$ & 131,85 s & $12$ \\
40,28 s & $129$ & 66,23 s & $42$ & 132,72 s & $9$  \\
41,92 s & $127$ & 70,97 s & $39$ & 173,93 s & $6$  \\
44,58 s & $97$  & 79,56 s & $36$ &          &      \\
\bottomrule
\end{tabular}
\end{table}
...
\section{Međuskalno poređenje}
\label{sec:finalna_normalizacija}

Apsolutne vrednosti funkcije cilja nisu neposredno uporedive između
skala: veća instanca ima više grupa kojima raspored može imati procepe i
više nastavnika kojima limit radnih dana može biti prekoračen, pa
očekujemo veći zbir kazni i kada je raspored jednako dobar. Zato uz
apsolutnu vrednost prikazujemo i cilj podeljen brojem sesija, odnosno
brojem nastavnika koji u datoj instanci imaju bar jedan čas. Rezultati
su u tabeli \ref{tbl:final_normalizovano}, za konfiguraciju sa osobljem
(bez osoblja nema nastavnika po kojima bi se normalizovalo).

\begin{table}[ht]
\centering
\caption{Normalizovana vrednost cilja, konfiguracija sa osobljem}
\label{tbl:final_normalizovano}
\begin{tabular}{lrrr}
\toprule
\textbf{Metrika} & \textbf{FINAL-S} & \textbf{FINAL-M} & \textbf{FINAL-L} \\
\midrule
Sesije      & $199$ & $378$ & $685$ \\
Nastavnici  & $39$  & $76$  & $109$ \\
\midrule
\multicolumn{4}{l}{\emph{Realno okruženje (8--20 časova)}} \\
Cilj prvog rešenja   & $48$    & $182$   & $282$   \\
\quad po sesiji      & $0,241$ & $0,481$ & $0,412$ \\
\quad po nastavniku  & $1,231$ & $2,395$ & $2,587$ \\
Najbolji cilj        & $0$     & $0$     & $0$     \\
\midrule
\multicolumn{4}{l}{\emph{Zaoštreno okruženje (8--14 časova)}} \\
Cilj prvog rešenja   & $14$    & $45$    & $200$   \\
\quad po sesiji      & $0,070$ & $0,119$ & $0,292$ \\
\quad po nastavniku  & $0,359$ & $0,592$ & $1,835$ \\
Najbolji cilj        & $3$     & $6$     & $6$     \\
\quad po sesiji      & $0,015$ & $0,016$ & $0,009$ \\
\quad po nastavniku  & $0,077$ & $0,079$ & $0,055$ \\
\bottomrule
\end{tabular}
\end{table}

Normalizacija menja sliku na dva mesta. Prvo, rast početne kazne sa
skalom je manji nego što apsolutne vrednosti sugerišu: u realnom
okruženju cilj prvog rešenja raste 5,9 puta od najmanje do najveće skale
(48 na 282), ali po nastavniku svega 2,1 puta (1,231 na 2,587), a od
srednje do najveće skale gotovo da i ne raste. Drugo, kvalitet konačnog
rešenja u zaoštrenom okruženju \emph{ne} opada sa veličinom problema --
najbolji cilj po sesiji iznosi 0,015, 0,016 i 0,009, dakle najveća
instanca daje relativno najbolji raspored. Rešavač, dakle, veće instance
ne rešava lošije, nego samo sporije.
...
Uvođenje nastavnog osoblja otprilike udvostručuje model: broj
promenljivih raste 2,2 do 2,4 puta, a broj ograničenja oko 2,1 puta na
svim skalama. Zanimljivo je da broj sesija pritom \emph{opada} (na
primer, sa 722 na 685 na najvećoj skali). Razlog je pojam kohorte iz
odeljka \ref{sec:cohorts}: dodele oblika
\texttt{"groupIds": ["2la", "2lb"]} spajaju više grupa u jedan
zajednički čas, pa nastavnik isto predavanje ne drži dva puta. Rast
modela, dakle, ne dolazi od većeg broja časova nego od pomoćnih
promenljivih kojima se izražavaju pravila osoblja.

\subsection{Ponašanje funkcije cilja kroz vreme}

U konfiguraciji bez osoblja rešavač na svim skalama prvim pronađenim
rešenjem odmah pogađa optimum, odnosno raspored bez ijednog procepa.
Meko ograničenje procepa se, uz spajanje časova u blokove, zadovoljava
bez ustupaka, pa optimizacija praktično nema šta da popravlja.

U konfiguraciji sa osobljem slika je bitno drugačija. Prvo rešenje je
osetno lošije (48, 182 i 282 na skalama S, M i L), jer u njemu veliki
broj nastavnika radi više dana nego što im je dozvoljeno. Odatle
rešavač u nizu koraka spušta cilj do nule, kroz ukupno 4 nađena rešenja
na najmanjoj, 16 na srednjoj i 23 na najvećoj instanci. Poboljšanja su
gusta i neravnomerna -- najveći skokovi dešavaju se rano (na primer, sa
106 na 99 u svega 0,7 sekundi na skali L), dok poslednji koraci do nule
traju duže jer je preostale prekršaje sve teže ukloniti.

\subsection{Skalabilnost}

Vreme do prvog dopustivog rešenja raste sa veličinom instance
(1,42 s, 4,13 s i 20,74 s bez osoblja), što je očekivano jer raste i
broj sesija koje treba smestiti u isti broj termina i učionica. Ukupno
vreme do dokazano optimalnog rešenja u konfiguraciji sa osobljem iznosi
3,05 s, 10,58 s i 30,96 s. Na najvećoj instanci konfiguracija sa
osobljem je prvo rešenje našla čak i nešto ranije od one bez osoblja
(18,81 s naspram 20,74 s), što treba pripisati nedeterminističkoj
paralelnoj pretrazi, a ne prednosti većeg modela.
...
pokretanje završeno je za oko 31 sekundu, što je nešto više od 5\%
raspoloživog vremena. Prošireni model, dakle, ne samo da ostaje rešiv
posle svih dodatih ograničenja, nego i dalje ima znatnu rezervu za
buduća proširenja navedena u glavi \ref{chp:zakljucak}.
...
radnog dana sa dvanaest na šest časova ne menja nijedno ograničenje
modela, a vreme rešavanja najveće instance sa osobljem raste sa 31 na
174 sekunde, dok cilj prestaje da bude dostižan u nuli.

Zanimljiv je i obrt na najvećoj skali: u zaoštrenom okruženju
konfiguracija \emph{bez} osoblja teže nalazi prvo rešenje od one sa
osobljem (273,07 s naspram 37,44 s). Objašnjenje je ponovo pojam kohorte
iz odeljka \ref{sec:cohorts} -- dodele nastavnika spajaju grupe u
zajedničke časove, pa instanca sa osobljem ima 685 umesto 722 časa. Kada
je popunjenost termina oko 79\%, tih 37 časova razlike odlučuje koliko
će rešavač tražiti prvo dopustivo rešenje. Drugim rečima, na granici
rešivosti veći model može biti lakši od manjeg ako opisuje manje posla.

Vredi primetiti i da je početna kazna u zaoštrenom okruženju
\emph{manja} nego u realnom (200 naspram 282 na najvećoj skali), iako je
okruženje strože. U kratkom danu jednostavno ima manje prilika za
...
je manji ali sadrži nesvodiv ostatak.
